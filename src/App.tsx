                              ...
                              <td className="px-6 py-4 text-center">
                                <div className="flex items-center justify-center gap-2">
                                  {ped.status !== 'Entregue' && ped.status !== 'Cancelado' ? (
                                    <button
                                      onClick={() => openReceiveModal(ped.id)}
            ...
            <div className="space-y-6" id="pedidos-tab-view">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-md text-sm font-semibold transition-all flex items-center gap-2 self-start"
                >
